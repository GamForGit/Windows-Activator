...
:ato
echo ============================================================================&echo.&echo.&cscript //nologo slmgr.vbs /ato | find /i "successfully" && (echo.&echo ============================================================================&echo.&echo #Our page: gamingforecast.com&echo.&echo #How it works: bit.ly/kms-server&echo.&echo #Thank you for downloading from us.&echo.&echo #Feel free to check our page: gamingforecast.com, your support is helping us keep our servers running 24/7!&echo.&echo ============================================================================&choice /n /c YN /m "Would you like to visit our page [Y,N]?" & if errorlevel 2 exit) || (echo The connection to our KMS server failed! Trying to connect to another one... & echo Please wait... & echo. & echo. & set /a i+=1 & goto skms)
explorer "https://www.gamingforecast.com"&goto halt
:notsupported
